...
const fsection = () => {
    return (<>
        ...
        <div className="text-center ppmain">
            ...
            <div><p className="copy_rights cgray">© 2022 - The Generic Technology. All Rights Reserved. The certification names are the trademarks of their respective owners.</p>
            </div>
        </div>
